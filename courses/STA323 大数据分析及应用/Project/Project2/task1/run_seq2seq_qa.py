...
class ModelArguments:
    ...
    model_name_or_path: str = field(
        default = "./data/Task1/flan-t5-small/",
...
class DataTrainingArguments:
    ...
    train_file: Optional[str] = field(
        default="./data/Task1/squad_v2/squad_v2/train-00000-of-00001.csv", 
    ...
    test_file: Optional[str] = field(
        default="./data/Task1/squad_v2/squad_v2/validation-00000-of-00001.csv",
...
def main():
    ...
    metric = evaluate.load(
        "squad_v2" if data_args.version_2_with_negative else "squad_v2", cache_dir=model_args.cache_dir
    )
