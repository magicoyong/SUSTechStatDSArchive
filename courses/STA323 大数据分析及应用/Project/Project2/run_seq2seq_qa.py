...
root_dir = "/data/lab/STA323/project2/"
...
class ModelArguments:
    ...
    model_name_or_path: str = field(
        default = root_dir + "./data/Task1/flan-t5-small/",
...
class DataTrainingArguments:
    ...
    train_file: Optional[str] = field(
        default=root_dir + "./data/Task1/squad_v2/squad_v2/train-00000-of-00001.csv", 
    ...
    test_file: Optional[str] = field(
        default=root_dir + "./data/Task1/squad_v2/squad_v2/validation-00000-of-00001.csv",
...
class MyDataTrainingArguments(DataTrainingArguments):
    output_dir: str = field(
        default = root_dir + "./output/debug_seq2seq_squad/",
        metadata={"help": "The output directory where the model predictions and checkpoints will be written."},
    )
            
class MySeq2SeqArguments(Seq2SeqTrainingArguments):
    output_dir: str = field(
        default = root_dir + "./output/debug_seq2seq_squad/",
        metadata={"help": "The output directory where the model predictions and checkpoints will be written."},
    )
...
def main():
    ...
    # pdb.set_trace()
    parser = HfArgumentParser((ModelArguments, MyDataTrainingArguments, MySeq2SeqArguments))
    if len(sys.argv) == 2 and sys.argv[1].endswith(".json"):
        ...
        training_args = MySeq2SeqArguments(output_dir = root_dir + "./output/debug_seq2seq_squad/")
    # training_args.output_dir = "./output/debug_seq2seq_squad/"
    ...
    def preprocess_squad_batch(
        ...
        answers = [eval(row, {"array": array, "int32": int32}) for row in examples[answer_column]]
    ...
    metric = evaluate.load(
        "/data/lab/STA323/project2/squad_v2/squad_v2.py" if data_args.version_2_with_negative else "/data/lab/STA323/project2/squad_v2/squad_v2.py", cache_dir=model_args.cache_dir
    )
...
#     trainer = ray.train.huggingface.transformers.prepare_trainer(trainer)
    ...
    if training_args.do_train:
        ...
        trainer.save_model(root_dir + f"./output/model{time.time()}.pth")  # Saves the tokenizer too for easy upload
...
#     main()
    run_config = RunConfig(name = "project2")
    # training_args = TrainingArguments(
    #     output_dir = "./output/trainer", evaluation_strategy = "epoch", report_to = "none"
    # )
    ...
    with result.checkpoint.as_directory() as checkpoint_dir:
        ...
        checkpoint_path = os.path.join(
            ...
            datasets={
                "train": ray.data.read_csv(root_dir + "./data/Task1/squad_v2/squad_v2/train-00000-of-00001.csv"),
                "test": ray.data.read_csv(root_dir + "./data/Task1/squad_v2/squad_v2/validation-00000-of-00001.csv")
            }
        )
